...
ce-replace`collectionUUID`[updateDescription.disambiguatedPaths](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/change-events/update/#std-label-ce-update-ud-disambiguatedPaths)## Summary

`replace`
A `replace` event occurs when an operation replaces all fields in a document with new values, such as when [`replaceOne`](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/method/db.collection.replaceOne/#mongodb-method-db.collection.replaceOne) is called or when an [`update`](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/command/update/#mongodb-dbcommand-dbcmd.update) command performs a document replacement.
...
<td headers="Description">
Together with the [lsid](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/change-events/replace/#std-label--idref--lsid), a number that helps uniquely identify a transction.
